      ...
      <Form onSubmit={submitHandler}>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="gridAoName">
              ...
              <Form.Control
                ...
                value={ao.aoName}
                onChange={myChangeHandler("aoName")}
              />
            </Form.Group>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="gridStartTime">
              ...
              <Form.Control
                ...
                value={ao.startTime}
                onChange={myChangeHandler("startTime")}
              />
            </Form.Group>
            ...
            <Form.Group as={Col} controlId="gridStopTime">
              ...
              <Form.Control
                ...
                value={ao.endTime}
                onChange={myChangeHandler("endTime")}
              />
            </Form.Group>
          </Row>
          ...
          <Row>
            <Form.Group as={Col} controlId="gridSiteQId">
              ...
              <Form.Control
                as="select"
                aria-label="Site Q"
                onChange={myChangeHandler("siteQId")}
              >
        ...
        {showAssignments ? (
          <Container className="p-3">
            ...
            <Row>
              <Col>
                <Button variant="primary" type="button" onClick={newAssignment}>
                  New Assignment
                </Button>
              </Col>
            </Row>
