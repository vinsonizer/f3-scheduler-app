...
import AosContainer from "../ao/AosContainer";
    ...
    <Container>
      <Form onSubmit={submitHandler}>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="gridRegionName">
              ...
              <Form.Control
                ...
                onChange={myChangeHandler("regionName")}
              />
            </Form.Group>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} controlId="gridLocation">
              ...
              <Form.Control
                ...
                onChange={myChangeHandler("location")}
              />
            </Form.Group>
            ...
            <Form.Group as={Col} controlId="gridWebsite">
              ...
              <Form.Control
                ...
                value={region.website}
                onChange={myChangeHandler("website")}
              />
            </Form.Group>
          </Row>
        </Container>
        <Container className="m-3">
          ...
          <Row>
            <Col className="text-right offset-md-10">
              <Button variant="primary" type="button" onClick={newAo}>
                Add AO
              </Button>
            </Col>
          </Row>
